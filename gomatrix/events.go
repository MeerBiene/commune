...
type Event struct {
	...
	Replies      []*Event               `json:"replies,omitempty"`
	TotalReplies int                    `json:"total_replies,omitempty"`
...
type Post struct {
	...
	Article         *Article          `json:"commune.article,omitempty"`
	ShareReply      *bool             `json:"share_reply"`
	ReplyPermalink  *string           `json:"reply_permalink"`
	Review          *Review           `json:"commune.review,omitempty"`
}
